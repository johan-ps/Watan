...
TextDisplay::TextDisplay(std::vector<std::string> resources, std::vector<std::string> tileValues, std::vector<std::string> criteria, std::vector<std::string> goals):
    resources{resources}, values{tileValues}, criteria{criteria}, goals{goals} {}
    
TextDisplay::TextDisplay(std::vector<std::string> resources, std::vector<std::string> tileValues):
    resources{resources}, values{tileValues} {
        for (int i = 0; i < 54; i++) {
